...
def main():
    ...
    kmer2vec = Kmer2vec(embedding_size=256, batch_size=64, learningRate=0.025, window_size=10)
    ...
    print('length of data: %d\n' % len(kmer2vec._corpus))
    logs_file.write('length of data: %d' % len(kmer2vec._corpus))
